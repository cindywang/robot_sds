'''
  ...
  in class StanfordTagger function tag_sents calling java
  the classpath argument was originally set to be 'self._stanford_jar'
  change it to be os.environ['CLASSPATH']
'''
